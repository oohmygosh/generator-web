 ...
 * 全局策略
 */
const globalStrategy = base + '/strategy'
const globalStrategyApi = {
    get: globalStrategy + '/get'
}
export const GlobalStrategy = {
    ...
    save: (params: Generator.SysGeneratorStrategy, config?: AxiosRequestConfig) => http.post<boolean>(globalStrategy + (params.id ? '/update' : '/create'), params,config)
}
